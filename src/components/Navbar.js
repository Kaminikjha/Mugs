      ...
      <section className="w-full bg-black text-white flex justify-between items-center py-6 lg:px-16">
        <div className="w-full flex justify-between items-center h-14 mx-5 sm:p-3">
          ...
          {toggle ? (
            ...
            <IoMenu
              onClick={() => setToggle(!toggle)}
              className="fa-solid fa-bars text-4xl md:hidden block"
            />
          )}
          ...
          <div className="flex flex-col">
            ...
            <li>
              ...
              <li>
                <a
                  className="text-lg text-slate-100 cursor-pointer rounded-sm px-5 py-2 bg-orange-600 hover:text-white active:text-white"
                  href="#download CV"
                >
                  Download CV
                </a>
          ...
          <ul
            className={` duration-300 md:hidden w-full h-screen fixed block bg-black  top-[82px] 
          ${toggle ? "left-[0]" : "left-[-100%]"} `}
          >
            <li className=" p-3 ">
              <a
                className="text-lg text-slate-100 cursor-pointer rounded-sm px-5 py-2 hover:bg-sky-700 hover:text-white active:text-white"
                href="/"
              >
                Home
              </a>
            ...
            <li className=" p-3" >
                <a
                  className="text-lg text-slate-100 cursor-pointer rounded-sm px-5 py-2  hover:text-white active:text-white"
                  href="#download CV"
                >
                  Download CV
                </a>
